...
import {changeTodolistFilter, changeTodolistTitle, FilterType, todolistsReducer} from "./app/store/todolists-reducer";
import {TaskBLLType, tasksReducer, updateTask} from "./app/store/tasks-reducer";
...
//Business Logic Layer
  ...
  const removeTask = (id: string, todolistID: string) => {
    dispatchInTasksReducer(removeTask(id, todolistID))
  }
  const addTask = (title: string, todolistID: string,) => {
    dispatchInTasksReducer(addTask({
      addedDate: '',
      deadline: '',
      description: '',
      id: 'bla',
  ...
  const changeTaskStatus = (todolistID: string, taskID: string, status: TaskStatuses,) => {
    dispatchInTasksReducer(updateTask(todolistID, taskID, {status},))
  }
  const changeTaskTitle = (taskID: string, title: string, todolistID: string) => {
    dispatchInTasksReducer(updateTask(todolistID, taskID, {title},))
  }
  //todolists
